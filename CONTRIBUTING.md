Contributing to MrGrower Core
============================

The MrGrower Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MrGrower Core project, and is not to be
confused with overall MrGrower Network Protocol consensus changes.

Whether a pull request is merged into MrGrower Core rests with the project merge
...
Patches that change MrGrower consensus rules are considerably more involved than
...
Where a patchset proposes to change the MrGrower consensus, it must have been
...
The project leader is the release manager for each MrGrower Core release.
