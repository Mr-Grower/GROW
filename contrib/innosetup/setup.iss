...
#define MyAppName "MrGrower Core"
#define MyAppPublisher "2022 MrGrower Core Developers"
#define MyAppURL "https://mrgrower.org/"
#define MyAppExeName "grower-qt.exe"
#define MyAppExtraData "https://explorer.mrgrower.org/bootstraps/GROW/bootstrap.zip"
...
DefaultDirName={autopf}\MrGrower
...
OutputDir=.\output
OutputBaseFilename=MrGrowerSetup
...
DefaultGroupName=MrGrower Core
...
Name: bootstrap; Description: "Bootstrap blockchain files";  Types: full; ExtraDiskSpaceRequired: 1027604480;
...
[Files]
Source: ".\package\grower-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\MrGrower\MrGrower-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\MrGrower\MrGrower-Qt,strDataDir|{userappdata}\MrGrower\}');
  Result := True;
end;
