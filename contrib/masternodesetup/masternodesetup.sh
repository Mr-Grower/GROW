...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='grower.conf'
CONFIGFOLDER='/root/.grower'
COIN_DAEMON='growerd'
COIN_CLI='grower-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/Mr-Grower/GROW/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
