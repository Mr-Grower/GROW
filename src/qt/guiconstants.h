...
/* MrGrower GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MrGrower"
#define QAPP_ORG_DOMAIN "grower.org"
#define QAPP_APP_NAME_DEFAULT "MrGrower-Qt"
#define QAPP_APP_NAME_TESTNET "MrGrower-Qt-testnet"
