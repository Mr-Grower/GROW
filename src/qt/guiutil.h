...
/** Utility functions used by the MrGrower Qt UI.
 */
namespace GUIUtil
{
...
// Render GROW addresses in monospace font
...
// Parse "grower:" URI into recipient object, return true on successful parsing
