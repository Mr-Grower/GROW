...
// Copyright (c) 2021-2024 The MrGrower Core Developers
...
CAmount CRewards::GetBlockValue(int nHeight)
{
    ...
    // ---- Static reward table ----
    if (nHeight > 5600000)      nSubsidy =       0.1 * COIN;
    else if (nHeight > 4400000) nSubsidy =       0.2 * COIN;
    else if (nHeight > 3250000) nSubsidy =       0.4 * COIN;
    else if (nHeight > 2600000) nSubsidy =       1.5 * COIN;
    else if (nHeight > 1850000) nSubsidy =       0.9 * COIN;
    else if (nHeight > 1200000) nSubsidy =       0.125 * COIN;
    else if (nHeight >  700000) nSubsidy =       0.25 * COIN;
    else if (nHeight >   10000) nSubsidy =       0.3 * COIN;
    else if (nHeight >     100) nSubsidy =        15 * COIN;
    else if (nHeight >       0) nSubsidy =      4900 * COIN;
    else nSubsidy = 0;
    // ---- Static reward table ----
