...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop MrGrower server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "MrGrower server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GROW features */
        {"grower", "listmasternodes", &listmasternodes, true },
        {"grower", "getmasternodecount", &getmasternodecount, true },
        {"grower", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"grower", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"grower", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"grower", "masternodecurrent", &masternodecurrent, true },
        {"grower", "startmasternode", &startmasternode, true },
        {"grower", "reloadmasternodeconfig", &reloadmasternodeconfig, true },
        {"grower", "createmasternodekey", &createmasternodekey, true },
        {"grower", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"grower", "listmasternodeconf", &listmasternodeconf, true },
        {"grower", "getactivemasternodecount", &getactivemasternodecount, true },
        {"grower", "getmasternodestatus", &getmasternodestatus, true },
        {"grower", "getmasternodewinners", &getmasternodewinners, true },
        {"grower", "getmasternodescores", &getmasternodescores, true },
        {"grower", "mnsync", &mnsync, true },
        {"grower", "spork", &spork, true },
        {"grower", "mnping", &mnping, true },
...
{
    return "> grower-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:47184/\n";
}
