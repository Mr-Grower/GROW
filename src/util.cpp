...
const char * const PIVX_CONF_FILENAME = "grower.conf";
const char * const PIVX_PID_FILENAME = "grower.pid";
const char * const PIVX_MASTERNODE_CONF_FILENAME = "masternode.conf";
const char * const PIVX_ACTIVE_MASTERNODE_CONF_FILENAME = "activemasternode.conf";


// MrGrower only features
// Masternode
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\grower
// Windows >= Vista: C:\Users\Username\AppData\Roaming\grower
// Mac: ~/Library/Application Support/grower
// Unix: ~/.grower
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "MrGrower";
#else
    fs::path pathRet;
    ...
    return pathRet / "MrGrower";
#else
    // Unix
    return pathRet / ".grower";
#endif
#endif
}
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty grower.conf if it does not exist
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override grower.conf
