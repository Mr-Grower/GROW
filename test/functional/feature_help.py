...
"""Verify that starting grower with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start grower with -? for help text")
        ...
        self.log.info("Start grower with -version for version information")
