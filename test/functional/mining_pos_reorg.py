...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected GROW supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check GROW supply at the beginning
        # ------------------------------------------
        # GROW supply: block rewards minus burned fees for minting
        ...
        # Verify that GROW supplies were properly updated after the spends and reorgs
        self.log.info("Check GROW supply...")
